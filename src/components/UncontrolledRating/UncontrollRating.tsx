...
export const UncontrollRating = React.memo(UncontrollRatingNotMemo)
function UncontrollRatingNotMemo(props: DefaultRatingType) {
...
const Star = React.memo(StarNotMemo)
function StarNotMemo(props: StarPropsType) {
